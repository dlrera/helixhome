    ...
    <div className="space-y-6">
      ...
      <div className="border-b pb-6">
        ...
        <p className="text-lg text-gray-600">
          Browse our library of 20+ pre-built maintenance templates to keep your
          home in top condition. Apply templates to your assets to automatically
        ...
        {appliedTemplateIds.length > 0 && (
          <div className="mt-4 inline-flex items-center gap-2 text-sm text-green-700 bg-green-50 px-3 py-1.5 rounded-full">
            ...
            <span className="font-medium">
              {appliedTemplateIds.length} template
              {appliedTemplateIds.length !== 1 ? 's' : ''} currently applied
            </span>
          </div>
        )}
      </div>
      ...
      <Suspense fallback={<TemplateSkeleton />}>
        <TemplatesPageClient appliedTemplateIds={appliedTemplateIds} />
      </Suspense>
    </div>
  )
}
