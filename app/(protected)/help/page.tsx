    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Get help with using HelixIntel
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Help and support features are planned for future development
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <ul className="list-disc list-inside mt-4 space-y-2 text-gray-600">
            <li>Searchable knowledge base and FAQs</li>
            <li>Video tutorials and guides</li>
            <li>Contact support form</li>
