...
export const completeTaskSchema = z.object({
  completionNotes: z.string().max(2000, "Completion notes must be less than 2000 characters").optional(),
...
export const taskFilterSchema = z.object({
  status: z.array(z.enum(["PENDING", "IN_PROGRESS", "COMPLETED", "OVERDUE", "CANCELLED"])).optional(),
